                ...
                <div className='max-w-[1320px] lg:mx-auto mx-2' id='myAccount-mid'>
                    ...
                    <div className='py-5' id='about-us-image'>
                        ...
                        <div className='text-center my-3' id='about-us-content'>
                            <h2 className='text-2xl font-semibold'>Welcome to Monsta!</h2>
                            <p className='text-[15px] text-[#5a5a5a] font-normal py-4'>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam, est usus legentis in iis qui facit eorum claritatem. </p>
                            <p className='text-[#c09578] italic'>“There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.”</p>
                        </div>
                    </div>
                </div>
            </section>
